...
`,
  ...
  ・根号の中をできるだけ小さくする
  ・分母に根号があるときは有理化する
  ・例：$\\sqrt{8} = \\sqrt{4×2} = 2\\sqrt{2}$

  有理化：
  ・分母に根号があるとき、分母と分子に同じ根号をかける
  ・例：$\\frac{1}{\\sqrt{3}} = \\frac{\\sqrt{3}}{3}$
...
`,
                pitfall: {
                    ...
                    detail: `
$\\sqrt{a} + \\sqrt{b} = \\sqrt{a + b}$ ではありません。
根号の中の数が同じ場合のみ、係数を足し引きできます。
例えば、$2\\sqrt{3} + 4\\sqrt{3} = 6\\sqrt{3}$ ですが、$\\sqrt{2} + \\sqrt{3}$ はこれ以上簡単にできません。

また、有理化の際に分母と分子にかける数を間違えることもあります。
例：$\\frac{1}{\\sqrt{3}}$ の有理化では、分母と分子に$\\sqrt{3}$をかけます。
`,
                },
                problems: normalizeProblems([
                    {
                        question: "$\\sqrt{8} + \\sqrt{2}$ を簡単にしなさい。",
                        answer: "$3\\sqrt{2}$",
                        hint: "$\\sqrt{8} = 2\\sqrt{2}$ に変形してから計算しましょう。",
                    },
                    {
                        question: "$\\sqrt{12} × \\sqrt{3}$ を計算しなさい。",
                        answer: "$6$",
                        hint: "$\\sqrt{12} = 2\\sqrt{3}$ に変形してから計算しましょう。",
                    },
                    {
                        question: "$\\frac{1}{\\sqrt{3}}$ を有理化しなさい。",
                        answer: "$\\frac{\\sqrt{3}}{3}$",
                        hint: "分母と分子に$\\sqrt{3}$をかけましょう。",
                    },
                ]),
            },
        ],
